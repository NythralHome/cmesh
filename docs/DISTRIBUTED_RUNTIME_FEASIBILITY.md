...
- `llama.cpp-stage-experimental`, which probes the installed `llama-cli` and reports the missing CDIP stage hooks. It intentionally remains `ready: false` until real layer-stage activation hooks exist.
