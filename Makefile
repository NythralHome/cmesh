...
.PHONY: test run build dist clean docker worker-desktop-run worker-desktop-test worker-desktop-build release-dry-run release-candidate deploy-alpha help
